...
<body>
  ...
  <div style="text-align: center; margin-bottom: 40px; margin-top: 2rem; font-family: 'Inter', sans-serif;">
  ...
  <div class="main-content" style="max-width: 800px; margin: 0 auto;">
    ...
    <div class="gallery-section">
      ...
      <div class="image-grid">
        ...
        <div class="grid-item"><img src="sketches/Sketch8.jpg" alt="Sketch 8" style="object-position: 90% 50%;" onerror="this.style.display='none'"></div>
